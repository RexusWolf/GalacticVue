...
export default {
  ...
  data: () => ({
    ...
    cards: [
      ...
      {name: 'Starships', path: '/starships', cardImageUrl: 'https://firebasestorage.googleapis.com/v0/b/galacticvue.appspot.com/o/starships%2F10.jpg?alt=media&token=f463f811-c296-4aca-89c2-287ad980a2e4'}
    ]
  }),
};
</script>
